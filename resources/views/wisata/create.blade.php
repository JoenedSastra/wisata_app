...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-success { background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); color: white; box-shadow: 0 4px 12px rgba(17,153,142,0.3); }
...
<body>
    ...
    <div class="container">
        <div class="page-header">
            <h2>Tambah Tempat Wisata Baru</h2>
        </div>
        ...
        <div class="card">
            <form action="{{ route('wisata.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nama_wisata" name="nama_wisata" class="form-control" placeholder="Contoh: Pantai Kuta" required>
                    @error('nama_wisata')
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="lokasi" name="lokasi" class="form-control" placeholder="Contoh: Bali" required>
                    @error('lokasi')
                        <span class="alert alert-danger" style="margin-top: 0.5rem; display: block;">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="harga_tiket" name="harga_tiket" class="form-control" placeholder="Contoh: 50000" required>
                    @error('harga_tiket')
                        <span class="alert alert-danger" style="margin-top: 0.5rem; display: block;">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="deskripsi" name="deskripsi" class="form-control" placeholder="Jelaskan tentang tempat wisata ini..." required></textarea>
                    @error('deskripsi')
                        <span class="alert alert-danger" style="margin-top: 0.5rem; display: block;">{{ $message }}</span>
                    @enderror
                </div>
